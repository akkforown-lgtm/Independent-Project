...
const translations = {
  ru: {
    ...
    "rooms.roomLimitReached": "Достигнут лимит номеров типа \"{room}\" на выбранные даты ({limit}). Выберите другие даты или номер.",
    ...
    "booking.pastDates": "Даты не могут быть в прошлом.",
    "booking.pastDatesConstraint": "Выбирайте даты начиная с сегодня, прошлые даты недоступны для бронирования.",
    ...
    "dashboard.cardAdded": "Ваша карта добавлена!",
    "dashboard.cardDeleted": "Ваша карта удалена",
    "dashboard.enterValidCardNumber": "Введите корректный номер карты (16 цифр).",
    "dashboard.fillAllFields": "Заполните все поля",
    "auth.fillAllFields": "Пожалуйста, заполните все поля",
    "auth.passwordTooShort": "Пароль должен быть минимум 6 символов",
    "auth.invalidPhoneFormat": "Некорректный номер телефона (+7 11 цифр или +998 12 цифр)",
    "auth.signingIn": "Вход...",
    "auth.registering": "Регистрация...",
    "alert.success.title": "Успешно",
  ...
  en: {
    ...
    "rooms.roomLimitReached": "The limit for room \"{room}\" has been reached for the selected dates ({limit}). Please choose other dates or a different room.",
    ...
    "booking.pastDates": "Dates cannot be in the past.",
    "booking.pastDatesConstraint": "Please select dates starting from today, past dates are not available for booking.",
    ...
    "dashboard.cardAdded": "Your card has been added!",
    "dashboard.cardDeleted": "Your card has been deleted",
    "dashboard.enterValidCardNumber": "Enter a valid card number (16 digits).",
    "dashboard.fillAllFields": "Fill in all fields",
    "auth.fillAllFields": "Please fill in all fields",
    "auth.passwordTooShort": "Password must be at least 6 characters",
    "auth.invalidPhoneFormat": "Invalid phone number (+7 11 digits or +998 12 digits)",
