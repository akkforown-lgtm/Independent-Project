...
const t = {
  ru: {
    ...
    name: 'Название', price: 'Цена', category: 'Категория', size: 'Размер', description: 'Описание',
    image: 'Выбрать фото', perNight: '/ночь',
  ...
  en: {
    ...
    name: 'Name', price: 'Price', category: 'Category', size: 'Size', description: 'Description',
    image: 'Choose Photo', perNight: '/night',
