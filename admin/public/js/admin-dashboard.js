  ...
  try {
    ...
    content.innerHTML = `
      <div class="animate-fade-in-down">
        ...
        <div class="grid grid-cols-5 gap-6 mb-10 responsive-stats">
        ...
        <div class="bg-zinc-900 rounded-2xl p-6">
          ...
          <div class="space-y-2">
            ${bookings.slice(0, 5).map(b => `
              <div class="booking-row flex md:flex-row flex-col justify-between items-start p-3 rounded-xl bg-zinc-800/50">
                <div class="flex-1">
                ...
                <div class="mt-3 md:mt-0 md:text-right">
                  ...
                  <p class="text-sm font-semibold mt-3 md:mt-1">$${b.totalPrice || 0}</p>
                </div>
              </div>
            `).join('')}
